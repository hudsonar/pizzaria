...
<body>
	...
	<div class="container">
		<div class="page-header">
			...
			<form method="post" name="myform" class="form-horizontal" action="<%=request.getContextPath()%>/cliente/atualizar">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" name="codCliente" id="codCliente" value="${item.codCliente}" required="required" readonly="readonly" class="form-control"/>
					</div>
				</div>
